import { CatAction, ActionMovement, ActionResult } from '@/domain/actions/CatAction';
import { ActionContext } from '@/domain/actions/ActionContext';
import { AnimationCommand } from '@/types/AnimationCommand';

class TestCatAction extends CatAction {
...
class MinimalTestAction extends CatAction {
  constructor() {
    super('minimalAction');
  }
...
describe('CatAction', () => {
  let testAction: TestCatAction;
  let minimalAction: MinimalTestAction;
  let context: ActionContext;

  beforeEach(() => {
    testAction = new TestCatAction('customAction');
  ...
  describe('getName', () => {
    ...
    it('デフォルト名を取得できる', () => {
      const defaultAction = new TestCatAction();
...
describe('CatAction Integration Tests', () => {
  class CustomAction extends CatAction {
