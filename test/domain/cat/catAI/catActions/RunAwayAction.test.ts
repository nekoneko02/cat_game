...
describe('RunAwayAction', () => {
  ...
  describe('目標地点に向かって逃げる動作', () => {
    ...
    it('理想的な逃げ先が画面外の場合、画面端にクランプした位置を目標にする', () => {
      ...
      // クランプ後: (750, 300)
      const context = ActionContext.withToy(700, 300, 600, 300, false, false);
    ...
    it('右端から左上に逃げたい場合、画面内に収まる位置を目標にする', () => {
      ...
      const context = ActionContext.withToy(750, 300, 680, 280, false, false);
    ...
    it('コーナーに追い詰められた状態', () => {
      ...
      const context = ActionContext.withToy(750, 550, 650, 450, false, false);
    ...
    it('目標地点に到着した場合、scaredで停止', () => {
      ...
      const context = ActionContext.withToy(750, 300, 200, 300, false, false);
  ...
  describe('execute', () => {
    describe('ユーザー位置(toy)から離れる方向に移動', () => {
      ...
      it('ユーザーが右にいる場合、左方向に逃げる', () => {
        const context = ActionContext.withToy(400, 300, 600, 300, false, false);
      ...
      it('ユーザーが上にいる場合、下方向に逃げる', () => {
        const context = ActionContext.withToy(400, 300, 400, 200, false, false);
      ...
      it('ユーザーが下にいる場合、上方向に逃げる', () => {
        const context = ActionContext.withToy(400, 300, 400, 400, false, false);
      ...
      it('ユーザーが左上にいる場合、右下方向に逃げる', () => {
        const context = ActionContext.withToy(400, 300, 200, 200, false, false);
    ...
    describe('画面端での動作', () => {
      ...
      it('画面端だがユーザーが近い場合(<=100px): escapeで逃げ続ける', () => {
        ...
        const context = ActionContext.withToy(750, 300, 680, 300, false, false);
      ...
      it('境界値: ユーザーとの距離がちょうど100pxの場合: escapeで逃げ続ける', () => {
        ...
        const context = ActionContext.withToy(750, 300, 650, 300, false, false);
      ...
      it('境界値: ユーザーとの距離が101pxの場合: scaredで停止', () => {
        ...
        const context = ActionContext.withToy(750, 300, 649, 300, false, false);
      ...
      it('左端での動作確認', () => {
        ...
        const context = ActionContext.withToy(50, 300, 400, 300, false, false);
      ...
      it('上端での動作確認', () => {
        ...
        const context = ActionContext.withToy(400, 50, 400, 400, false, false);
      ...
      it('下端での動作確認', () => {
        ...
        const context = ActionContext.withToy(400, 550, 400, 200, false, false);
...
describe('RunAwayAction Integration Tests', () => {
  ...
  it('シナリオ: ユーザーから逃げて端で怯える完全な流れ', () => {
    ...
    const context1 = ActionContext.withToy(400, 300, 100, 300, false, false);
    ...
    // 移動中: さらに右に移動(600, 300)
    const context2 = ActionContext.withToy(600, 300, 100, 300, false, false);
    ...
    const context3 = ActionContext.withToy(750, 300, 100, 300, false, false);
  ...
  it('シナリオ: ユーザーが追いかけてきたら端でも逃げ続ける', () => {
    ...
    const context1 = ActionContext.withToy(750, 300, 100, 300, false, false);
    const result1 = action.execute(context1);
    ...
    const context2 = ActionContext.withToy(750, 300, 680, 300, false, false);
    const result2 = action.execute(context2);
  ...
  it('シナリオ: ユーザーの位置が変わると逃げる方向も変わる', () => {
    // ユーザーが左上にいる
    const context1 = ActionContext.withToy(400, 300, 200, 200, false, false);
    const result1 = action.execute(context1);
    ...
    // ユーザーが右下に移動
    const context2 = ActionContext.withToy(400, 300, 600, 400, false, false);
    const result2 = action.execute(context2);
  ...
  it('シナリオ: 4つの端全てに逃げられる', () => {
    // 右端
    const context1 = ActionContext.withToy(400, 300, 200, 300, false, false);
    const result1 = action.execute(context1);
    expect(result1.deltaX).toBeGreaterThan(0);

    // 左端
    const context2 = ActionContext.withToy(400, 300, 600, 300, false, false);
    const result2 = action.execute(context2);
    expect(result2.deltaX).toBeLessThan(0);

    // 下端
    const context3 = ActionContext.withToy(400, 300, 400, 200, false, false);
    const result3 = action.execute(context3);
    expect(result3.deltaY).toBeGreaterThan(0);

    // 上端
    const context4 = ActionContext.withToy(400, 300, 400, 400, false, false);
