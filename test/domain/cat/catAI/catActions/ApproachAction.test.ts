  ...
  describe('execute', () => {
    describe('ユーザー位置(toy)に向かって移動', () => {
      it('ユーザーが右にいる場合、右方向に移動', () => {
        const context = ActionContext.withToy(400, 300, 550, 300, false, false);
      ...
      it('ユーザーが左にいる場合、左方向に移動', () => {
        const context = ActionContext.withToy(400, 300, 250, 300, false, false);
      ...
      it('ユーザーが上にいる場合、上方向に移動', () => {
        const context = ActionContext.withToy(400, 300, 400, 150, false, false);
      ...
      it('ユーザーが下にいる場合、下方向に移動', () => {
        const context = ActionContext.withToy(400, 300, 400, 550, false, false);
    ...
    describe('ユーザーとの距離による動作', () => {
      ...
      it('ユーザーとの距離がちょうど100pxの場合: idleで停止', () => {
        // 距離100px
        const context = ActionContext.withToy(400, 300, 500, 300, false, false);
      ...
      it('ユーザーとの距離が101pxの場合: walkで近づく', () => {
        // 距離101px
        const context = ActionContext.withToy(400, 300, 501, 300, false, false);
      ...
      it('ユーザーとの距離が99pxの場合: idleで停止', () => {
        // 距離99px
        const context = ActionContext.withToy(400, 300, 499, 300, false, false);
    ...
    describe('flipX判定', () => {
      ...
      it('停止時のflipX判定: 左方向に近づいて停止', () => {
        ...
        const context = ActionContext.withToy(400, 300, 301, 300, false, false);
...
describe('ApproachAction Integration Tests', () => {
  ...
  it('シナリオ: ユーザーに近づいて停止する完全な流れ', () => {
    ...
    const context1 = ActionContext.withToy(300, 300, 500, 300, false, false);
    ...
    // 移動中: ユーザーとの距離が120px
    const context2 = ActionContext.withToy(380, 300, 500, 300, false, false);
    ...
    const context3 = ActionContext.withToy(450, 300, 500, 300, false, false);
  ...
  it('シナリオ: ユーザーが離れたら再び近づく', () => {
    // 距離50pxで停止している
    const context1 = ActionContext.withToy(450, 300, 500, 300, false, false);
    const result1 = action.execute(context1);
    ...
    // ユーザーが離れた(距離150px)
    const context2 = ActionContext.withToy(450, 300, 600, 300, false, false);
    const result2 = action.execute(context2);
  ...
  it('シナリオ: ユーザーの位置が変わると移動方向も変わる', () => {
    // ユーザーが右にいる
    const context1 = ActionContext.withToy(400, 300, 550, 300, false, false);
    const result1 = action.execute(context1);

    expect(result1.deltaX).toBeGreaterThan(0);

    // ユーザーが左に移動
    const context2 = ActionContext.withToy(400, 300, 250, 300, false, false);
    const result2 = action.execute(context2);
